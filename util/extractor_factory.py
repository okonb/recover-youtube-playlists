...
def extractor_factory(extractor_version: str, file_time_created: float,
                      extra_info: bool, id_only: bool) -> Extractor:
    ...
    return extractor_version_map[extractor_version](extra_info, id_only)
